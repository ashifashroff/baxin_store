...
<div class="max-w-7xl mx-auto px-4 pb-16 flex gap-6">
    ...
    <aside class="hidden lg:block w-56 shrink-0">
        <form method="GET" id="filter-form">
            ...
            <button type="submit" class="w-full bg-blue-600 text-white text-sm font-medium py-2.5 rounded-full hover:bg-blue-700 transition">Apply</button>
    ...
    <div class="flex-1 min-w-0">
        <div class="flex items-center justify-between mb-5 flex-wrap gap-3">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">{{ $category->name ?? 'Shop' }}</h1>
